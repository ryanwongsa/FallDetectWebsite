...
package uk.ac.gla.alexmtmorgan.falldetect.toolbox;
...
public class SslHttpClient extends DefaultHttpClient {
    ...
    protected ClientConnectionManager createClientConnectionManager() {
        ...
        try {
            SSLSocketFactory sf = new SslSocketFactory(mKeyStore, mKeyStorePassword);
            registry.register(new Scheme(HTTP_SSL_SCHEME, mHttpsPort, sf));
